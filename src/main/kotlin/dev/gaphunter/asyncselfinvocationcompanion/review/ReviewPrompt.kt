package dev.gaphunter.asyncselfinvocationcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.asyncselfinvocationcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.asyncselfinvocationcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Async Self-Invocation Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33874-async-self-invocation-companion/reviews"
